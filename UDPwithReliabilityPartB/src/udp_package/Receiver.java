...
public class Receiver {
	...
	private static void createFile () {
		File file = new File("/Users/yingjianwu/Documents/Java/LeetcodePractice/linkedList/UDPwithReliabilityPartB/src/MobyDick_out.txt");
	...
	private static void writeFile(String line) throws IOException {
		File fout = new File("/Users/yingjianwu/Documents/Java/LeetcodePractice/linkedList/UDPwithReliabilityPartB/src/MobyDick_out.txt");
...
//			int x = ran.nextInt(100) + 110; //sleep between
//			try {
//				Thread.sleep(x);
//			} catch (InterruptedException e) {
//				// TODO Auto-generated catch block
